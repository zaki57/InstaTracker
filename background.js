...
var domains = {},
  ...
  loadDomains = function(e) {
    return (
      storageLocal.load(STORAGE_DOMAINS, {}, function(a) {
        e(a),
          dcl("Domains loaded: " + Object.keys(domains).length + " domains");
      }),
      !0
    );
  },
  ...
  loadSecondsAlltime = function() {
    return (
      storageLocal.load(STORAGE_SECONDS_ALLTIME, 0, function(e) {
        (seconds.alltime = e[STORAGE_SECONDS_ALLTIME]),
          saveSecondsAlltime(),
          dcl("Seconds alltime loaded: " + e[STORAGE_SECONDS_ALLTIME]);
      }),
      !0
    );
  },
  ...
  loadIdleTime = function() {
    return (
      storageLocal.load(STORAGE_IDLE_TIME, IDLE_TIME_DEFAULT, function(e) {
        (settings.idleTime = e[STORAGE_IDLE_TIME]),
          saveIdleTime(),
          dcl("Idle time loaded: " + e[STORAGE_IDLE_TIME]);
      }),
      !0
    );
  },
  ...
  loadGraphGap = function() {
    return (
      storageLocal.load(STORAGE_GRAPH_GAP, GRAPH_GAP_DEFAULT, function(e) {
        (settings.graphGap = e[STORAGE_GRAPH_GAP]),
          saveGraphGap(),
          dcl("Graph gap loaded: " + e[STORAGE_GRAPH_GAP]);
      }),
      !0
    );
  },
  ...
  loadBadgeDisplay = function() {
    return (
      storageLocal.load(STORAGE_BADGE_DISPLAY, BADGE_DISPLAY_DEFAULT, function(
        e
      ) {
        (settings.badgeDisplay = e[STORAGE_BADGE_DISPLAY]),
          saveBadgeDisplay(),
          dcl("Badge display loaded: " + e[STORAGE_BADGE_DISPLAY]);
      }),
      !0
    );
  },
  saveBadgeDisplay = function() {
    return (
      storageLocal.save(
        STORAGE_BADGE_DISPLAY,
        settings.badgeDisplay,
        function() {
  ...
  setBadgeDisplay = function(e) {
    return (
      (settings.badgeDisplay =
        "boolean" == typeof e ? e : BADGE_DISPLAY_DEFAULT),
      !0
    );
  },
  loadScreenshotInstructionsRead = function() {
    return (
      storageLocal.load(
        STORAGE_SCREENSHOT_INSTRUCTIONS_READ,
        SCREENSHOT_INSTRUCTIONS_READ_DEFAULT,
        function(e) {
          (settings.screenshotInstructionsRead =
            e[STORAGE_SCREENSHOT_INSTRUCTIONS_READ]),
            saveScreenshotInstructionsRead(),
            dcl(
              "Storage instructions set loaded: " +
                e[STORAGE_SCREENSHOT_INSTRUCTIONS_READ]
            );
        }
      ),
  ...
  saveScreenshotInstructionsRead = function() {
    return (
      storageLocal.save(
        ...
        function() {
          dcl(
            "Storage instructions set saved: " +
              settings.screenshotInstructionsRead
          );
        }
      ),
        ...
        chrome.idle.queryState(settings.idleTime, function(o) {
          ...
          if (
            ...
            (i.days[dates.today] = i.days[dates.today] || getDayObj()),
              e ||
                ((i.alltime.seconds += INTERVAL_UPDATE_S),
                (i.days[dates.today].seconds += INTERVAL_UPDATE_S),
