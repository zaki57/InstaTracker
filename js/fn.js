...
var dclCounter = 0,
  ...
  getDomainObj = function() {
    return { name: "", alltime: { seconds: 0 }, days: {} };
  },
  getDayObj = function() {
    return { seconds: 0 };
  },
  getTimeObj = function() {
    return {
      day: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_DAY },
      hour: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_HOUR },
      minute: {
        tens: 0,
        units: 0,
        implicitlyActive: !1,
  ...
  addDelegateEventListener = function(e, t, n) {
    ...
    return (
      document.addEventListener(t, function(t) {
        t.stopPropagation(),
          (r = getClosestMatchingAncestor(t.target, e)),
          r && n(t, r);
      }),
      !0
    );
  ...
  getDateDiffDays = function(e, t) {
    ...
    return (
      (r = new Date(e)),
      (o = new Date(t)),
      (n = parseInt(r.getTime() - o.getTime()) / 864e5),
      (n = Math.abs(n))
    );
  },
  getTotalSecondsForDate = function(e, t) {
    var n = 0;
    for (var r in e)
      e.hasOwnProperty(r) && e[r].days[t] && (n += e[r].days[t].seconds);
    return n;
  },
  ...
  getIdleTimeComputedFromRaw = function(e) {
    ...
    return (
      "undefined" == typeof t &&
        ((t = IDLE_TIME_DEFAULT), console.error("Undefined raw value: " + e)),
      t
    );
  },
  ...
  getSliderComputedFromRaw = function(e, t, n) {
    ...
    return (
      "undefined" == typeof r &&
        ((r = t), console.error("Undefined raw value: " + n)),
      r
    );
  },
  getSliderRawFromComputed = function(e, t, n) {
    ...
    return (
      -1 === r &&
        ((r = e.indexOf(t)),
        console.error("Computed value with no match: " + n)),
      r
    );
  },
  getDatesSparse = function(e, t) {
    var n,
      r = [],
      o = new Date(e);
    for (r.push(e), n = 0; t > n; n++)
      o.setDate(o.getDate() + 1), r.push(getDateString(o));
    return r;
  },
  convertArrayToCsv = function(e, t, n) {
    var r,
      ...
      s = [];
    for (
      r = getDateDiffDays(t, n),
        s = getDatesSparse(t, r),
      ...
      for (d += o[i], a = 0; a < s.length; a++)
        (u = e[o[i]].days[s[a]]), (d += "," + (u ? u.seconds : 0));
      d += "\n";
    }
    return d;
  },
  initiateDownload = function(e, t, n) {
    var r = new Blob(e, { type: t }),
  ...
  getAvailableElementWidth = function(e) {
    var t = 0;
    return (
      (t += parseInt(window.getComputedStyle(e).getPropertyValue("width"))),
      (t -= parseInt(
      ...
      (t -= parseInt(
        window.getComputedStyle(e).getPropertyValue("border-left-width")
      )),
      (t -= parseInt(
        window.getComputedStyle(e).getPropertyValue("border-right-width")
      ))
    );
  };
