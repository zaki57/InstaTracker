...
var backgroundJS = chrome.extension.getBackgroundPage(),
  htmlTemplates = document.querySelector(
  ...
  getDomainsData = function(e, t) {
    ...
    if (
      ...
      for (i in a)
        a.hasOwnProperty(i) &&
          a[i].days.hasOwnProperty(r) &&
          ((d = (a[i].days[r].seconds / s) * 100),
    ...
    for (
      ...
      n.domains[i].graphed && (n.domains[i].color = getHSL(i, u));
    return n;
  },
  ...
  renderControlBadgeDisplay = function() {
    ...
    (html = tplHtmlBadgeDisplayControl(e)),
      htmlRenderInto("badge-display", html);
  },
        ...
        function(e) {
          if (
            ...
            if (!backgroundJS.settings.screenshotInstructionsRead) {
              var t = htmlTemplates.querySelector(
  ...
  screenshotUICaptureHide = function() {
    return (
      (document.querySelector(".screenshot-capture").style.display = "none"), !0
    );
  },
...
initialize(),
    ...
    function(e, t) {
      ...
      if ("click" === e.type) "other" !== d && window.open("http://" + d);
        ...
        var u = document.querySelectorAll(
          "#table-" + o + ' tr.domain[data-connect-id="' + i + '"]'
        );
        if ("mouseover" === e.type) {
    ...
    function(e, t) {
      ...
      if ("click" === e.type && t.classList.contains("domain"))
        ...
        var d = document.querySelector(
          "#doughnut-" + s + ' .group[wt\\:connect-id="' + o + '"]'
        );
        if (d) {
          if ("mouseover" === e.type) {
  ...
  addMultipleDelegatedEventListeners(
    ...
    function(e, t) {
      ...
      return (
        "mouseover" === e.type
          ? ((n.innerHTML = r),
            (a.innerHTML = tplHtmlTimeObjectFragment({
              value: s,
  ...
  addMultipleDelegatedEventListeners("#pseudomodal .menu a", "click", function(
    e,
    t
  ) {
    e.preventDefault();
    ...
    if ("stats" === n) {
      ...
      if ("1" !== s.dataset.statsReady) {
        ...
        if (
          (elementInsertIntoElement(s.querySelector(".text"), l),
          i.days.visited > 0)
        ) {
          ...
          elementInsertIntoElement(
            s.querySelector(".chart-daynames .chart"),
            u
          );
        }
  ...
  addMultipleDelegatedEventListeners(
    ...
    function(e, t) {
      ...
      return (
        (document.querySelector(
          "#pseudomodal #idle-time .display"
        ).innerHTML = r),
        "change" === e.type &&
          (backgroundJS.setIdleTime(a),
          backgroundJS.saveIdleTime(),
          dcl("Idle time saved: " + a)),
        !0
      );
    }
  ),
  addMultipleDelegatedEventListeners(
    ...
    function(e, t) {
      ...
      return (
        (document.querySelector(
          "#pseudomodal #graph-gap .display"
        ).innerHTML = n),
        "change" === e.type &&
          (backgroundJS.setGraphGap(a),
          backgroundJS.saveGraphGap(),
          renderUIRange(RANGE_TODAY, RESOLUTION_HOURS, !0, !1, !1),
          renderUIRange(RANGE_AVERAGE, RESOLUTION_DAYS, !0, !1, !1),
          renderUIRange(RANGE_ALLTIME, RESOLUTION_DAYS, !0, !1, !1),
          dcl("Graph gap saved: " + a)),
        !0
      );
    }
  ),
  addMultipleDelegatedEventListeners(
    ...
    function(e, t) {
      ...
      return (
        "change" === e.type &&
          (backgroundJS.setBadgeDisplay(n),
          backgroundJS.saveBadgeDisplay(),
          backgroundJS.updateDomains(!0),
          dcl("Badge display saved: " + n)),
        !0
      );
    }
  ),
  addMultipleDelegatedEventListeners("#pseudomodal .trigger", "click", function(
    e,
    t
  ) {
    e.preventDefault();
    ...
    function(e, t) {
      ...
      return (
        ...
        t.classList.contains("active")
          ...
          : (t.classList.add("active"),
            (n.innerText = n.dataset.active),
            a.classList.add("running", "warning"),
            (a.querySelector(".shifter").style.animationDuration =
  ...
  addMultipleDelegatedEventListeners(".screenshot-info .ok", "click", function(
    e,
    t
  ) {
...
var restoreFromJson = function(e) {
    var t = document.querySelector("#pseudomodal .options-restore"),
      ...
      a = t.querySelector(".loading"),
      r = function() {
        (n.innerText = n.dataset.warning),
          a.classList.add("blinking", "warning"),
          (a.querySelector(".shifter").style.animationDuration =
            UI_LOADING_BLINKING_INTERVAL + "ms"),
          (a.querySelector(
            ".shifter"
          ).style.animationIterationCount = UI_LOADING_BLINKING_COUNT),
          setTimeout(function() {
            (n.innerText = n.dataset["default"]),
      ...
      s = function() {
        (n.innerText = n.dataset.restored),
          a.classList.add("blinking", "success"),
          (a.querySelector(".shifter").style.animationDuration =
            UI_LOADING_BLINKING_INTERVAL + "ms"),
          (a.querySelector(
            ".shifter"
  ...
  renderDomainStats = function(e) {
    ...
    if ("1" !== e.contextEl.dataset.statsReady) {
      ...
      (n = Object.assign(n, e)),
        (n.color = e.contextEl.querySelector(".label span").style.color);
      var a = htmlTemplates.querySelector("#stats-domain");
      tplElementStatsDomain(n, a.content);
      var r = document.importNode(a.content, !0);
      elementInsertAfterElement(e.contextEl, r),
      ...
      elementInsertIntoElement(t.querySelector(".chart-daynames .chart"), l),
  ...
  getDomainData = function(e) {
    ...
    for (
      d = getDatesSparse(backgroundJS.dates.start, v - 1),
        l = [0, 0, 0, 0, 0, 0, 0],
        a = 0;
      a < d.length;
      a++
    ...
    return (r = {
      ...
      _defineProperty(
        n,
        RANGE_TODAY,
        E.days[backgroundJS.dates.today]
          ? E.days[backgroundJS.dates.today].seconds || 0
          : 0
      ),
      _defineProperty(n, RANGE_AVERAGE, parseInt(E.alltime.seconds / v)),
      _defineProperty(
        n,
        RANGE_AVERAGE + "-pure",
        parseInt(E.alltime.seconds / h)
      ),
      _defineProperty(n, RANGE_ALLTIME, E.alltime.seconds),
      n),
      dates: {
        start: backgroundJS.dates.start,
  ...
  getOverallData = function() {
    var e,
      ...
      v =
        getDateDiffDays(backgroundJS.dates.today, backgroundJS.dates.start) + 1;
    (l = getDatesSparse(backgroundJS.dates.start, v - 1)),
      (c = [0, 0, 0, 0, 0, 0, 0]),
      (s = {});
    ...
    return (n = {
      ...
      times: ((e = {}),
      _defineProperty(e, RANGE_TODAY, backgroundJS.seconds.today),
      _defineProperty(
        e,
        RANGE_AVERAGE,
        parseInt(backgroundJS.seconds.alltime / v)
      ),
      _defineProperty(
        e,
        RANGE_AVERAGE + "-pure",
        E > 0 ? parseInt(backgroundJS.seconds.alltime / E) : 0
      ),
      _defineProperty(e, RANGE_ALLTIME, backgroundJS.seconds.alltime),
      e),
      dates: {
        start: backgroundJS.dates.start,
        today: backgroundJS.dates.today,
